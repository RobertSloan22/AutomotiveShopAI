...
import { EngineDiagram } from '../components/EngineDiagram/EngineDiagram.js';

import './ConsolePage.scss';
import { isJsxOpeningLikeElement } from 'typescript';
import { carmdService } from '../services/carmd.js';
          ...
          <div className="content-block repair-history">
            ...
            <div className="content-block-body full">
              {Object.entries(memoryKv).map(([vehicleId, repairs]) => (
                <div key={vehicleId} className="vehicle-history">
